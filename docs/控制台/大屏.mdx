...
<ImagePreview alt="大屏列表管理" src="/img/docs/控制台/list-introduction.png" />
...
<VideoPreview src="/img/docs/控制台/list-export.mp4" />
...
<VideoPreview src="/img/docs/控制台/list-copy.mp4" />  
...
<ImagePreview alt="大屏列表管理" src="/img/docs/控制台/list-share.png" />
...
<ImagePreview alt="大屏列表管理" src="/img/docs/控制台/list-preview.png" />

### 删除 {#delete}  

<ImagePreview alt="大屏列表管理" src="/img/docs/控制台/list-delete.png" />
...
<ImagePreview alt="大屏列表管理" src="/img/docs/控制台/list-enable.png" />